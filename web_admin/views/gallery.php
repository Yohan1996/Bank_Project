        ...
        <div class="row">
          <div class="col-12">
              <div class="row float-right">
                <div class="col-sm-12">
                  <button type="button" class="btn btn-block btn-primary btn-sm" data-toggle="modal" data-target="#modal_gallery" style="background-color: #1023ac; border-color: #1023ac;"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Gallery Images</button>
                </div>  
              </div>
              <br>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" style="background-color: #1023ac; border-color: #1023ac;" onclick="saveUpdateGallery()">Yes</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
      ...
      <div class="modal fade" id="modal_gallery_delete_confirm">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
              <button type="button" class="btn btn-primary" style="background-color: #1023ac; border-color: #1023ac;" onclick="deleteImage()">Yes</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>

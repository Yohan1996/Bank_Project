  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="container-fluid">
        <div class="row mt-4">
          <div class="col-sm-3">
            <button type="button" class="btn btn-block btn-primary btn-sm" data-toggle="modal" data-target="#modal_news" style="background-color: #1023ac; border-color: #1023ac;"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add News or Promotion</button>
          </div>  
        </div>
      </div><!-- /.container-fluid --> 
    </section>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" style="background-color: #1023ac; border-color: #1023ac;" onclick="saveUpdateNews()">Yes</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
      ...
      <div class="modal fade" id="modal_delete_news_confirm">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
              <button type="button" class="btn btn-primary" style="background-color: #1023ac; border-color: #1023ac;" onclick="deleteNews()">Yes</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
